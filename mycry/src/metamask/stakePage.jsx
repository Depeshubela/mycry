          ...
          <div className='mt-6 w-full h-[35%] flex flex-row gap-16'>
            <div className={classNames('w-full flex p-[13px] flex-col justify-between items-start color-[#f9f5ef] rounded-[10px] border-black bg-[#FFF5E9] m-0')}>
              <div>
                ...
                <h2 className='my-1 text-[#ad00ff] text-[22px] flex items-start font-[700]'>{userStaked ? Number((userStaked).toFixed(4)) : 0}<span className='text-[12px] ml-2'>$PLAY</span></h2>
              </div>
              <div>
                <span className='mb-1'><FormattedMessage defaultMessage="可質押" id="stake.balance"></FormattedMessage></span>
                <h2 className='my-1 text-[#ad00ff] text-[22px] flex items-start font-[700]'>{userNowBalance ? userNowBalance : 0}<span className='text-[12px] ml-2'>$PLAY</span></h2>
              </div>
            </div>
            <div className={classNames('w-full flex p-[13px] flex-col justify-between items-start color-[#f9f5ef] rounded-[10px] border-black bg-[#FFF5E9] m-0')}>
              <div>
                <span className='mb-1'><FormattedMessage defaultMessage="佔質押池百分比" id="stake.staked.percent"></FormattedMessage></span>
                <h2 className='my-1 text-[#ad00ff] text-[22px] flex items-start font-[700]'>{userStaked && allStaking ? Number(((userStaked) / allStaking * 100).toFixed(2)) : 0}%<span className='text-[12px] ml-2'>$PLAY</span></h2>
              </div>
              <div>
                <span className='mb-1'><FormattedMessage defaultMessage="總質押數" id="stake.totalStaked"></FormattedMessage></span>
                <h2 className='my-1 text-[#ad00ff] text-[22px] flex items-start font-[700]'>{allStaking ? allStaking : 0}<span className='text-[12px] ml-2'>$PLAY</span></h2>
              </div>
            ...
            <div className={classNames('w-full flex p-[13px] flex-col justify-between items-start color-[#f9f5ef] rounded-[10px] border-black bg-[#FFF5E9] m-0')}>
              <div>
                ...
                <h2 className='my-1 text-[#ad00ff] text-[22px] flex items-start font-[700]'>{userStaked && stakeRate != Number((userStaked).toFixed(4)) ? ((stakeRate / (userStaked) - 1) / 100).toFixed(4) : 0}%<span className='text-[12px] ml-2'>$PLAY</span></h2>
              </div>
            ...
            <div className={classNames('w-full flex p-[13px] flex-col justify-between items-start color-[#f9f5ef] rounded-[10px] border-black bg-[#FFF5E9] m-0')}>
              <div>
                ...
                <h2 className='my-1 text-[#ad00ff] text-[22px] flex items-start font-[700]'>{stakeRate != Number((userStaked).toFixed(4)) && userTotalBalance && userNowBalance ? (stakeRate - (userTotalBalance - userNowBalance)).toFixed(4) : 0}<span className='text-[12px] ml-2'>$PLAY</span></h2>
              </div>
            </div>
          </div>
        </div>
